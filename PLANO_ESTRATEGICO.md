...
```mermaid
flowchart TD
    A[CannaGuia Platform] --> B[1. Catálogo & Dados Unificados]
    A --> C[2. Fummelier IA Terapêutico]
...
```mermaid
graph LR
    A[Monetização CannaGuia] --> B[1. SaaS Médico]
    A --> C[2. Afiliação Vaporizadores]
    A --> D[3. Destaque de Associações]
    A --> E[4. Google Ads & Mídia]

    B --> B1[R$ 149 a R$ 349/mês por perfil de médico]
    C --> C1[8% a 15% de comissão por vape vendido]
    D --> D1[Selo Premium de fornecedor verificado]
    E --> E1[Banners programáticos no Blog]
```
