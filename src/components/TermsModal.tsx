...
export const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/70 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-white rounded-3xl border-2 border-emerald-500/30 shadow-2xl overflow-hidden my-auto max-h-[90vh] flex flex-col animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between p-5 sm:p-6 border-b bg-emerald-900 text-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-black">Termos de Uso & Política de Privacidade (LGPD)</h2>
              <p className="text-xs text-emerald-200">CannaGuia — Guia Informativo & Plataforma Terapêutica</p>
            </div>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-5 sm:p-8 space-y-6 overflow-y-auto text-xs sm:text-sm text-gray-700 leading-relaxed flex-1">
          ...
          <div className="space-y-2 pt-3 border-t border-gray-100">
            ...
            <ul className="list-disc pl-5 space-y-1.5 text-gray-600">
              ...
              <li><strong>Anonimização de Relatos:</strong> As avaliações públicas da comunidade são exibidas de forma protegida ou como "Paciente Anônimo", preservando a privacidade do usuário.</li>
        ...
        {/* Footer do Modal */}
        <div className="p-4 sm:p-5 border-t bg-gray-50 flex items-center justify-between shrink-0">
