...
export const INITIAL_STRAINS: Strain[] = [
  {
    ...
    "aromaFlavor": "Gorila Freak 🦍👾 Genética: Gorila Kush x Strolona Freak Terpeno dominante: Cariofileno 🔥🌶️ Aroma: terroso, especiado e amadeirado Sabor: picante, resinoso e marcante. Perfil: híbrido.",
    "description": "Gorila Freak 🦍👾 Genética: Gorila Kush x Strolona Freak Terpeno dominante: Cariofileno 🔥🌶️ Aroma: terroso, especiado e amadeirado Sabor: picante, resinoso e marcante. Perfil: híbrido.",
    "effects": [
  ...
  },
  {
    ...
    "aromaFlavor": "Gorila Kush 🦍 🧬 Genética: Gorilla Glue #4 x OG Kush 🌿 Terpeno dominante: Cariofileno 🔥🌶️ Perfil: híbrido Aroma: terroso, picante, amadeirado e resinoso Sabor: especiado, intenso e terroso. Estrutura aromática: encorpada e persistente",
    "description": "Gorila Kush 🦍 🧬 Genética: Gorilla Glue #4 x OG Kush 🌿 Terpeno dominante: Cariofileno 🔥🌶️ Perfil: híbrido Aroma: terroso, picante, amadeirado e resinoso Sabor: especiado, intenso e terroso. Estrutura aromática: encorpada e persistente",
    "effects": [
  ...
  },
  {
    ...
    "aromaFlavor": "Genética: Harlequin x Dancehall Terpeno dominante: Mirceno",
    "description": "Genética: Harlequin x Dancehall Terpeno dominante: Mirceno",
    "effects": [
      "Alívio de Ansiedade",
      "Anti-inflamatório",
  ...
  },
  {
    ...
    "aromaFlavor": "Kama Kush 🕉️ Genética: Kush x alto CBD Terpeno dominante: Cariofileno 🔥🌶️ Perfil: híbrido com seleção para alto CBD Aroma: terroso, picante, amadeirado e resinoso Sabor: especiado, herbal e encorpado Estrutura aromática: intensa, profunda e persistente.",
    "description": "Kama Kush 🕉️ Genética: Kush x alto CBD Terpeno dominante: Cariofileno 🔥🌶️ Perfil: híbrido com seleção para alto CBD Aroma: terroso, picante, amadeirado e resinoso Sabor: especiado, herbal e encorpado Estrutura aromática: intensa, profunda e persistente.",
    "effects": [
      "Alívio de Ansiedade",
      "Anti-inflamatório",
      "Clareza sem Psicoatividade"
  ...
  },
  {
    ...
    "aromaFlavor": "Mexican Ice ❄️ Genética: Mexican Sativa x Afghan Terpeno dominante: Limoneno 🍊 Perfil: híbrido Aroma: cítrico, fresco, herbal e terroso Sabor: cítrico, resinoso e levemente adocicado. Estrutura aromática: fresca, intensa e equilibrada Característica marcante: contraste entre notas cítricas e fundo terroso.",
    "description": "Mexican Ice ❄️ Genética: Mexican Sativa x Afghan Terpeno dominante: Limoneno 🍊 Perfil: híbrido Aroma: cítrico, fresco, herbal e terroso Sabor: cítrico, resinoso e levemente adocicado. Estrutura aromática: fresca, intensa e equilibrada Característica marcante: contraste entre notas cítricas e fundo terroso.",
    "effects": [
      "Foco & Disposição",
      "Estímulo Criativo",
      "Elevação de Humor"
  ...
  },
  {
    ...
    "aromaFlavor": "Mimosa 🐄 Genética: Clementine x Purple Punch Terpeno dominante: Limoneno 🍊 Perfil: híbrido Aroma: cítrico, frutado, doce e fresco Sabor: laranja, frutas maduras e notas levemente florais. Estrutura aromática: intensa, fresca e frutada Característica marcante: perfil cítrico expressivo com fundo doce.",
    "description": "Mimosa 🐄 Genética: Clementine x Purple Punch Terpeno dominante: Limoneno 🍊 Perfil: híbrido Aroma: cítrico, frutado, doce e fresco Sabor: laranja, frutas maduras e notas levemente florais. Estrutura aromática: intensa, fresca e frutada Característica marcante: perfil cítrico expressivo com fundo doce.",
    "effects": [
      "Foco & Disposição",
      "Estímulo Criativo",
      "Elevação de Humor"
  ...
  },
  {
    ...
    "terpenes": [
      "Mirceno 🍋 Perfil: híbrido com seleção para CBD Aroma: terroso, herbal, frutado e levemente cítrico Sabor: frutado, resinoso e encorpado Estrutura aromática: intensa, profunda e persistente Característica marcante: combinação de notas frutadas e terrosas com fundo Diesel"
    ],
    "aromaFlavor": "Purple Punch CBD 🍇 Genética: Sour Diesel x Purple CBD (Woo Seeds Bank) Terpeno dominante: Mirceno 🍋 Perfil: híbrido com seleção para CBD Aroma: terroso, herbal, frutado e levemente cítrico Sabor: frutado, resinoso e encorpado Estrutura aromática: intensa, profunda e persistente Característica marcante: combinação de notas frutadas e terrosas com fundo Diesel",
    "description": "Purple Punch CBD 🍇 Genética: Sour Diesel x Purple CBD (Woo Seeds Bank) Terpeno dominante: Mirceno 🍋 Perfil: híbrido com seleção para CBD Aroma: terroso, herbal, frutado e levemente cítrico Sabor: frutado, resinoso e encorpado Estrutura aromática: intensa, profunda e persistente Característica marcante: combinação de notas frutadas e terrosas com fundo Diesel",
    "effects": [
      "Alívio de Ansiedade",
      "Anti-inflamatório",
      "Clareza sem Psicoatividade"
  ...
  },
  {
    ...
    "aromaFlavor": "Purple Queen 👑 Genética: Hindu Kush x Purple Afghani Terpeno dominante: Mirceno 🍇 Perfil: híbrido com forte influência Kush/Afghani Aroma: terroso, herbal, frutado e resinoso Sabor: encorpado, levemente adocicado e especiado Estrutura aromática: profunda, intensa e persistente Característica marcante: perfil terroso e frutado com identidade clássica Kush",
    "description": "Purple Queen 👑 Genética: Hindu Kush x Purple Afghani Terpeno dominante: Mirceno 🍇 Perfil: híbrido com forte influência Kush/Afghani Aroma: terroso, herbal, frutado e resinoso Sabor: encorpado, levemente adocicado e especiado Estrutura aromática: profunda, intensa e persistente Característica marcante: perfil terroso e frutado com identidade clássica Kush",
    "effects": [
      "Relaxamento Corporal",
      "Sedação Noturna",
      "Alívio de Tensões"
  ...
  },
  {
    ...
    "aromaFlavor": "Strolona Freak 👾 Genética: Seleção própria Terpeno dominante: Cariofileno 🔥🌶️ Perfil: seleção própria Aroma: picante, terroso, amadeirado e herbal Sabor: especiado, resinoso e encorpado Estrutura aromática: intensa, profunda e persistente Característica marcante: perfil especiado e identidade genética exclusiva.",
    "description": "Strolona Freak 👾 Genética: Seleção própria Terpeno dominante: Cariofileno 🔥🌶️ Perfil: seleção própria Aroma: picante, terroso, amadeirado e herbal Sabor: especiado, resinoso e encorpado Estrutura aromática: intensa, profunda e persistente Característica marcante: perfil especiado e identidade genética exclusiva.",
    "effects": [
      "Equilíbrio Físico e Mental",
      "Ansiolítico Suave",
      "Alívio de Estresse"
  ...
  },
  {
    ...
    "terpenes": [
      "Cariofileno / Húmida Aroma: Doce, amanteigado, biscoito e baunilha. Começa com euforia e melhora do humor",
      "depois evolui para relaxamento corporal forte e prolongado."
    ],
  ...
  },
  {
    ...
    "aromaFlavor": "Genética: Chemdawg x Super Skunk (Limoneno) Sativa Dominante Aroma limão picante, especiarias terrosas e pinho herbáceo. Efeito estimulante, eufóricos e clareadores da mente. Potente e saborosa.",
    "description": "Genética: Chemdawg x Super Skunk (Limoneno) Sativa Dominante Aroma limão picante, especiarias terrosas e pinho herbáceo. Efeito estimulante, eufóricos e clareadores da mente. Potente e saborosa.",
    "effects": [
      "Alívio de Dores"
    ],
    "associations": [
  ...
  },
  {
    ...
    "aromaFlavor": "Genética: Bubba Kush pré-98 x Bubba Kush pré-98 (Terpeno dominante: Mirceno) Indica dominante Aroma picante, terroso, café, chocolate e especiarias. Efeito fortemente narcótico.",
    "description": "Genética: Bubba Kush pré-98 x Bubba Kush pré-98 (Terpeno dominante: Mirceno) Indica dominante Aroma picante, terroso, café, chocolate e especiarias. Efeito fortemente narcótico.",
    "effects": [
      "Relaxamento Corporal",
      "Sedação Noturna",
      "Alívio de Tensões"
  ...
  },
  {
    ...
    "terpenes": [
      "Mirceno 🥭 Perfil: híbrido Aroma: terroso, herbal, frutado e levemente cítrico Sabor: encorpado, resinoso e frutado Estrutura aromática: intensa, complexa e persistente Característica marcante: combinação de resina, frutas maduras e fundo herbal"
    ],
